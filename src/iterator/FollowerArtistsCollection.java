...
public class FollowerArtistsCollection implements Container {

    private Users[] users;

    public FollowerArtistsCollection(Users user){
        ...
        if(follows != null) {
            for (Follows follow : follows) {
                ...
                if (userFollowed != null && userFollowed.user_type == 1 && currentUser.user_id != userFollowed.user_id) {
