...
public class ListenerPicker {
    ...
    public ListenerPicker(TableView usersTv, HashMap<String, String> contextMenus){
        ...
        usersTv.getColumns().addAll(followStatusColumn, nameColumn , followersColumn);
    ...
    public void setUsersList(iterator.Iterator<Users> users){
        this.users = users;
        refreshAlbumsList();
    }
